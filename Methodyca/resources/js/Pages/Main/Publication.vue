<template>
    <app-layout imgPath="assets/">
        ...
        <publication-block pubTitle="Methodyca - Source Code for a Game." pubData="Tallinn, Estonia, April 2021" pubAbstract="Educational Game about learning research methods." linkHref="https://github.com/AShenawy/RM-Game" linkText="Link to source code."/>
		<publication-block pubTitle="Methodyca - A Study of the Development Process of a Game about Research Methods" pubAuthor="Ahmed ElShenawy" pubPublisher="Tallinn University" pubData="Tallinn, Estonia, June 2021" pubAbstract="Ahmed ElShenawy, a member of the development team behind Methodyca, has submitted and successfully defended his master thesis which discusses the development process of the main systems in the Methodyca game. This thesis also acts as a guideline document, along with the publicly available source code, for anybody who is interested in learning about the creation process of Methodyca." linkHref="./docs/MethodycaDev.pdf" linkText="Download full PDF here."/>
